...
class dinosaur{
  constructor(diet, weight, length, period){
    this.diet = diet;
    this.weight = weight;
    this.length = length;
    this.period = period;
...
const tyrannosaurus = new dinosaur("carnivorous", "7000kg", "12m", "Late Cretaceous");


// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaurus = new dinosaur("herbivorous", "2000kg", "9m", "Late Jurassic");

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor = new dinosaur("carnivorous", "15kg", "1.8m", "Late Cretaceous");
...
const unisWithUni = graduates.filter(student => student.university.includes("Uni")).map(student=> student.university);
...
*/
const animalPopulations = zooAnimals.map(animal => animal.population);
const populationTotal = animalPopulations.reduce(((a,b) => a + b), 0);
